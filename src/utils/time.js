 ...
 */
export const createYearViewArray = (displayDate, currentYear) => {
...
export const sanitizedNextMonth = (d) => {
...
export const sanitizedPreviousMonth = (d) => {
    const month = d.getMonth();
    const year = d.getFullYear();
    const date = d.getDate();
...
export const sortAscDates = (dates) => {
