...
export default css`
  *,
  ...
  .container-fluid {
    /* --sgds-gutter-x: 0.75rem;
    --sgds-gutter-y: 0; */
    margin-left: auto;
    margin-right: auto;
    padding-left: var(--sgds-gutter-x, 1.5rem); // calc(var(--sgds-gutter-x) * 0.5);
    padding-right: var(--sgds-gutter-x, 1.5rem); // calc(var(--sgds-gutter-x) * 0.5);
    width: 100%;
  }
  .row {
