---
name: "sgds-components-switch"
description: "Use sgds-switch to display a toggle switch for binary on/off controls. Apply this skill whenever a user asks about toggle switches, on/off toggles, boolean switches, feature toggles, or settings toggles in SGDS."
metadata:
