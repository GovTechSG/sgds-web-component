---
name: "sgds-components-toast"
description: "Use sgds-toast and sgds-toast-container web components to display brief, non-blocking notifications. Apply this skill whenever a user asks about toasts, notifications, alerts that auto-dismiss, snackbars, or toast positioning in SGDS."
metadata:
