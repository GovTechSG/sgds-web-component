---
name: sgds-components-masthead
description: "Use the sgds-masthead web component to render the mandatory Singapore Government official banner on every .gov.sg digital service page. Apply this skill whenever a user asks about the government masthead, official banner, 'A Singapore Government Agency Website' strip, how to place the gov.sg identity indicator on a page, or how to integrate the masthead in Next.js, React, Vue, or Angular."
metadata:
...
See **[sgds-components-setup](../components-setup/SKILL.md)** for installation and framework integration (React 19+ vs React ≤18, Vue, Angular).
