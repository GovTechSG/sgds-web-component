---
name: "sgds-components-footer"
description: "Use the sgds-footer web component to display the standard Singapore Government site footer with links, addresses, and site metadata. Apply this skill whenever a user asks about footers, site footers, government footers, footer links, or bottom of page navigation in SGDS."
metadata:
