---
name: sgds-utilities-border-width
description: "Use SGDS border width utilities with the sgds: prefix for border thickness and side control. Apply this skill whenever a user asks about border thickness, border sides, adding borders to elements, or controlling which sides have borders in SGDS designs."
metadata:
...
- **[utilities-border-color](../utilities-border-color/SKILL.md)** — Semantic and theme-aware border colors
- **[utilities-border-radius](../utilities-border-radius/SKILL.md)** — Rounded corner utilities
