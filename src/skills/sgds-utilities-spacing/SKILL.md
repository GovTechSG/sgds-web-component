...
description: "Use SGDS spacing utilities with the sgds: prefix for margin, padding, and gap. Apply this skill whenever a user asks about spacing, margins, padding, gaps, or layout spacing in SGDS designs."
metadata:
