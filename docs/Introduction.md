# Introduction to SGDS Web Component
...
<div class="home-card-container mt-5">
    <sgds-card stretchedLink class="col intro">
        ...
        <a slot="card-link" href="https://designsystem.tech.gov.sg/"></a>
     ...
     <sgds-card stretchedLink class="col intro">
        ...
        <a slot="card-link" href="https://custom-elements-everywhere.com/" ></a>
     ...
     <sgds-card stretchedLink class="col intro">
        ...
        <a slot="card-link" href="/story/getting-started-usage-stylings--page" ></a>
     ...
     <sgds-card stretchedLink class="col intro">
        ...
        <a slot="card-link" href="/story/getting-started-installation--page" ></a>
...
<sgds-card stretchedLink class="col intro">
        ...
        <a slot="card-link" href="https://github.com/GovTechSG/sgds-web-component" ></a>
    </sgds-card>
<sgds-card stretchedLink class="col intro">
        ...
        <a slot="card-link" href="/story/getting-started-extending-the-library--page" ></a>
    </sgds-card>
</div>
