  ...
  it("renders with default values", async () => {
    ...
    assert.shadowDom.equal(
      ...
      `
        ...
        <input type="text" class="form-control " id="test-id" aria-invalid="false" placeholder="">
    `
    );
  });
    ...
    assert.shadowDom.equal(
      ...
      `
        <div class="sgds form-control-group">
          ...
          <input type="text" placeholder="" class="form-control " id="defaultID" aria-invalid="false">
        </div>
      `
    );
  });
