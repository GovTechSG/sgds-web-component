...
describe("<sgds-link>", () => {
  ...
  it("if target=_blank rightIcon slot should render default svg", async () => {
    const el = await fixture<SgdsLink>(html`<sgds-link href="#"></sgds-link>`);
    assert.shadowDom.equal(
      el,
      `
