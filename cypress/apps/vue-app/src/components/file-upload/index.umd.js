  ...
  ***************************************************************************** */
  ...
  const ScopedElementsMixinImplementation = superclass =>
    ...
    class ScopedElementsHost extends superclass {
      ...
      createRenderRoot() {
        const { scopedElements, shadowRootOptions, elementStyles } = /** @type {typeof ScopedElementsHost} */ (
          this.constructor
        );
  ...
  const polyfillSupport$2 = global$2.reactiveElementPolyfillSupportDevMode;
  {
    ...
    const issuedWarnings =
      (_b$3 = global$2.litIssuedWarnings) !== null && _b$3 !== void 0 ? _b$3 : (global$2.litIssuedWarnings = new Set());
    ...
    if (
      ((_c$2 = global$2.ShadyDOM) === null || _c$2 === void 0 ? void 0 : _c$2.inUse) &&
      polyfillSupport$2 === undefined
    ) {
      issueWarning$2(
    ...
    extends HTMLElement
  {
          ...
          Object.defineProperty(this.prototype, name, descriptor);
          {
            ...
            if (!this.hasOwnProperty("__reactivePropertyKeys")) {
              this.__reactivePropertyKeys = new Set(
                (_a = this.__reactivePropertyKeys) !== null && _a !== void 0 ? _a : []
              );
            }
    ...
    createRenderRoot() {
      var _a;
      const renderRoot =
        (_a = this.shadowRoot) !== null && _a !== void 0 ? _a : this.attachShadow(this.constructor.shadowRootOptions);
    ...
    __propertyToAttribute(name, value, options = defaultPropertyDeclaration) {
      ...
      if (attr !== undefined && options.reflect === true) {
        const converter =
          ((_a = options.converter) === null || _a === void 0 ? void 0 : _a.toAttribute) !== undefined
            ? options.converter
            : defaultConverter;
    ...
    performUpdate() {
      ...
      if (!this.hasUpdated) {
        // Produce warning if any class properties are shadowed by class fields
        {
          ...
          (_a = this.constructor.__reactivePropertyKeys) === null || _a === void 0
            ? void 0
            : _a.forEach(p => {
                var _a;
                if (
                  this.hasOwnProperty(p) &&
                  !((_a = this.__instanceProperties) === null || _a === void 0 ? void 0 : _a.has(p))
                ) {
  ...
  const wrap =
    ((_b$2 = global$1.ShadyDOM) === null || _b$2 === void 0 ? void 0 : _b$2.inUse) &&
    ...
    for (let i = 0; i < l; i++) {
      ...
      html +=
        regex === textEndRegex
          ...
          : s + marker + (attrNameEndIndex === -2 ? (attrNames.push(undefined), i) : end);
    }
  ...
  class ChildPart {
    constructor(startNode, endNode, parent, options) {
      ...
      this.__isConnected =
        (_a = options === null || options === void 0 ? void 0 : options.isConnected) !== null && _a !== void 0
          ? _a
          : true;
      {
    ...
    get _$isConnected() {
      ...
      // state
      return (_b = (_a = this._$parent) === null || _a === void 0 ? void 0 : _a._$isConnected) !== null && _b !== void 0
        ? _b
        : this.__isConnected;
    }
    /**
  ...
  (_b$1 = globalThis.litElementHydrateSupport) === null || _b$1 === void 0
    ? void 0
    : _b$1.call(globalThis, { LitElement });
  // Apply polyfills if available
  ...
  ((_c = globalThis.litElementVersions) !== null && _c !== void 0 ? _c : (globalThis.litElementVersions = [])).push(
    "3.3.2"
  );
    ...
    return decorateProperty({
      descriptor: name => {
        const descriptor = {
          get() {
            var _a, _b;
            return (_b = (_a = this.renderRoot) === null || _a === void 0 ? void 0 : _a.querySelector(selector)) !==
              null && _b !== void 0
              ? _b
              : null;
          },
        ...
        if (cache) {
          ...
          descriptor.get = function () {
            ...
            if (this[key] === undefined) {
              this[key] =
                (_b = (_a = this.renderRoot) === null || _a === void 0 ? void 0 : _a.querySelector(selector)) !==
                  null && _b !== void 0
                  ? _b
                  : null;
            }
  ...
  const notifyChildrenConnectedChanged = (parent, isConnected) => {
    ...
    for (const obj of children) {
      ...
      // This property needs to remain unminified.
      (_b = (_a = obj)["_$notifyDirectiveConnectionChanged"]) === null || _b === void 0
        ? void 0
  ...
  var css_248z$2 = css`
    ...
    :root {
      ...
      --sgds-gradient: linear-gradient(180deg, hsla(0, 0%, 100%, 0.15), hsla(0, 0%, 100%, 0));
    ...
    *,
    ...
    .sgds.input-group[variant="quantity-toggle"] input::-webkit-outer-spin-button {
      -webkit-appearance: none;
      margin: 0;
    }
    .valid-feedback {
    ...
    .footer-list-styling ul,
    .sgds.footer .footer-contact-links ul,
    .sgds.footer .footer-items ul,
    .sgds.footer .footer-mandatory-links ul {
      margin: 0;
      padding: 0;
    }
    .footer-list-styling ul li,
    .sgds.footer .footer-contact-links ul li,
    .sgds.footer .footer-items ul li,
    ...
    .btn-check:focus + .btn-secondary,
    .btn-secondary:focus {
      box-shadow: 0 0 0 0.125rem rgba(65, 128, 255, 0.5);
    }
    ...
    .btn-check:focus + .btn-success,
    .btn-success:focus {
      box-shadow: 0 0 0 0.125rem rgba(47, 149, 58, 0.5);
    }
    ...
    .btn-check:focus + .btn-info,
    .btn-info:focus {
      box-shadow: 0 0 0 0.125rem rgba(51, 134, 197, 0.5);
    }
    ...
    .btn-check:focus + .btn-warning,
    .btn-warning:focus {
      box-shadow: 0 0 0 0.125rem rgba(210, 122, 8, 0.5);
    }
    ...
    .btn-danger:focus,
    .btn-danger:hover {
      background-color: #b7200d;
      border-color: #ac1e0c;
      color: #fff;
    }
    .btn-check:focus + .btn-danger,
    .btn-danger:focus {
      box-shadow: 0 0 0 0.125rem rgba(221, 71, 51, 0.5);
    }
    ...
    .btn-check:focus + .btn-light,
    .btn-light:focus {
      box-shadow: 0 0 0 0.125rem hsla(240, 2%, 83%, 0.5);
    }
    ...
    .btn-outline-primary:focus {
      box-shadow: 0 0 0 0.125rem rgba(89, 37, 220, 0.5);
    }
    ...
    .btn-outline-secondary:focus {
      box-shadow: 0 0 0 0.125rem rgba(31, 105, 255, 0.5);
    }
    ...
    .btn-outline-success:focus {
      box-shadow: 0 0 0 0.125rem rgba(10, 130, 23, 0.5);
    }
    ...
    .btn-outline-info:focus {
      box-shadow: 0 0 0 0.125rem rgba(15, 113, 187, 0.5);
    }
    ...
    .btn-outline-warning:focus {
      box-shadow: 0 0 0 0.125rem rgba(247, 144, 9, 0.5);
    }
    ...
    .btn-outline-danger:focus {
      box-shadow: 0 0 0 0.125rem rgba(215, 38, 15, 0.5);
    }
    ...
    .btn-outline-light:focus {
      box-shadow: 0 0 0 0.125rem rgba(247, 247, 249, 0.5);
    }
    ...
    .sgds.datepicker .month.active,
    .sgds.datepicker .year.active {
      background-color: #ece6fb;
      color: #5925dc;
    }
    .sgds.datepicker .month:focus-visible,
    .sgds.datepicker .year:focus-visible {
      outline: 2px auto #5925dc;
      z-index: 100;
    }
    .sgds.datepicker .month:hover,
    ...
    .sgds.card[variant*="card-action"]:hover {
      border-color: transparent;
      box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.15), inset 0 0 0 2.1px #0f71bb;
    }
    ...
    .accordion-button:not(.collapsed) {
      ...
      box-shadow: inset 0 -1px 0 #98a2b3;
      color: #5925dc;
    }
    .accordion-button:not(.collapsed):after {
      background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%235925DC'%3E%3Cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3E%3C/svg%3E");
      transform: rotate(-180deg);
    }
    .accordion-button:after {
      background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%231D2939'%3E%3Cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3E%3C/svg%3E");
      background-repeat: no-repeat;
    ...
    .sgds.sidenav .sidenav-item .sgds.btn.collapsed,
    .sgds.sidenav .sidenav-item .sgds.btn.inactive {
      border-color: transparent;
      color: inherit;
    }
    .sgds.sidenav .sidenav-item .sgds.btn.collapsed i,
    .sgds.sidenav .sidenav-item .sgds.btn.inactive i {
    ...
    .sgds.sidenav .sidenav-item .collapse,
    ...
    .sgds.sidenav.sticky {
      --sgds-sidenav-sticky-top: 0rem;
      max-height: calc(100vh - var(--sgds-sidenav-sticky-top));
      overflow-y: auto;
      position: sticky;
    ...
    sgds-aside-area {
      background: #fff;
      box-shadow: 3px 0 6px 0 rgba(208, 213, 221, 0.502);
      padding-bottom: 1.5rem;
      padding-top: 1.5rem;
      z-index: 10;
    }
    ...
    :host {
      ...
      --sgds-light-100: #f7f7f9;
      --sgds-light-200: #e4e7ec;
      --sgds-light-300: #d0d5dd;
      --sgds-light-400: #98a2b3;
      --sgds-light-500: #667085;
      --sgds-light-600: #344054;
      --sgds-light-700: #1d2939;
      --sgds-light-800: #000;
      --sgds-light-900: #000;
      --sgds-dark-100: #f7f7f9;
      --sgds-dark-200: #e4e7ec;
      --sgds-dark-300: #d0d5dd;
      --sgds-dark-400: #98a2b3;
      --sgds-dark-500: #667085;
      --sgds-dark-600: #344054;
      --sgds-dark-700: #1d2939;
      --sgds-dark-800: #000;
      --sgds-dark-900: #000;
      ...
      font-size: var(--sgds-body-font-size, 1rem);
      font-weight: var(--sgds-body-font-weight, 400);
      line-height: var(--sgds-body-line-height, 2);
    }
    :host ::slotted(a[target="_blank"]):after,
    :host a[target="_blank"]:after {
      background-color: currentColor;
      content: "/";
      display: inline-block;
      margin: 0 0.125rem;
  ...
  class SgdsElement extends LitElement {
    ...
    emit(name, options) {
      const event = new CustomEvent(
        name,
        Object.assign({ bubbles: true, cancelable: false, composed: true, detail: {} }, options)
      );
  ...
  __decorate([query(".btn")], SgdsButton.prototype, "button", void 0);
  __decorate([property({ reflect: true })], SgdsButton.prototype, "variant", void 0);
  __decorate([property({ reflect: true })], SgdsButton.prototype, "buttonClasses", void 0);
  __decorate([property({ reflect: true })], SgdsButton.prototype, "size", void 0);
  __decorate([property({ type: Boolean, reflect: true })], SgdsButton.prototype, "active", void 0);
  __decorate([property({ type: Boolean, reflect: true })], SgdsButton.prototype, "disabled", void 0);
  __decorate([property()], SgdsButton.prototype, "type", void 0);
  __decorate([property()], SgdsButton.prototype, "href", void 0);
  __decorate([property()], SgdsButton.prototype, "target", void 0);
  __decorate([property({ reflect: true })], SgdsButton.prototype, "download", void 0);
  __decorate([property()], SgdsButton.prototype, "form", void 0);
  __decorate([property({ attribute: "formaction" })], SgdsButton.prototype, "formAction", void 0);
  __decorate([property({ attribute: "formmethod" })], SgdsButton.prototype, "formMethod", void 0);
  __decorate(
    [property({ attribute: "formnovalidate", type: Boolean })],
    SgdsButton.prototype,
    "formNoValidate",
    void 0
  );
  __decorate([property({ attribute: "formtarget" })], SgdsButton.prototype, "formTarget", void 0);

  var css_248z = css`
    :host {
      --fileupload-left-icon-fill: green;
      --fileupload-remove-icon-fill: red;
      --fileupload-remove-icon-hover-fill: #c00;
    }
    .fileupload-list-item span {
      cursor: pointer;
    }
    .fileupload-list-item span:first-of-type svg {
      fill: var(--fileupload-left-icon-fill);
    }
    .fileupload-list-item span:last-of-type svg {
      fill: var(--fileupload-remove-icon-fill);
    }
    .fileupload-list-item span:last-of-type svg:hover {
    ...
    .drag-drop-area {
      align-items: center;
      border: 2px dashed var(--sgds-gray-300);
      border-radius: 4px;
      cursor: pointer;
      display: flex;
      flex-direction: row;
    ...
    .drag-drop-area.dragover {
      background-color: var(--sgds-primary-200);
  ...
  class SgdsFileUpload extends ScopedElementsMixin(SgdsElement) {
    ...
    _handleDragOver(event) {
      ...
      (_a = this.shadowRoot) === null || _a === void 0
        ? void 0
        : _a.querySelector("#drag-drop-area").classList.add("dragover");
    }
    /** @internal */
    _handleDragLeave(event) {
      ...
      (_a = this.shadowRoot) === null || _a === void 0
        ? void 0
        : _a.querySelector("#drag-drop-area").classList.remove("dragover");
    }
    /** @internal */
  ...
  __decorate([property({ reflect: true })], SgdsFileUpload.prototype, "variant", void 0);
  __decorate([property({ type: Boolean, reflect: true })], SgdsFileUpload.prototype, "disabled", void 0);
  __decorate([property({ type: Boolean, reflect: true })], SgdsFileUpload.prototype, "multiple", void 0);
  __decorate([property({ type: Number })], SgdsFileUpload.prototype, "maxFiles", void 0);
  __decorate([property({ type: String, reflect: true })], SgdsFileUpload.prototype, "accept", void 0);
  __decorate([property({ reflect: true })], SgdsFileUpload.prototype, "size", void 0);
  __decorate([property({ type: String })], SgdsFileUpload.prototype, "checkedIcon", void 0);
  __decorate([property({ type: String })], SgdsFileUpload.prototype, "cancelIcon", void 0);
  __decorate([property({ type: Object, state: true })], SgdsFileUpload.prototype, "files", void 0);
  __decorate([property({ type: Array })], SgdsFileUpload.prototype, "selectedFiles", void 0);
  __decorate([state()], SgdsFileUpload.prototype, "invalidFeedback", void 0);
