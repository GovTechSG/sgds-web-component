 ...
 */
    ...
    var __privateSet = (obj, member, value, setter) => (
      __accessCheck(obj, member, "write to private field"), member.set(obj, value), value
    );
    ...
    function createShadowRoot(cmpMeta) {
      ...
      if (globalStyleSheet === void 0)
        globalStyleSheet = (_a2 = createStyleSheetIfNeededAndSupported()) != null ? _a2 : null;
      if (globalStyleSheet) {
        {
    ...
    function queryNonceMetaTagContent(doc) {
      var _a2, _b, _c;
      return (_c =
        (_b = (_a2 = doc.head) == null ? void 0 : _a2.querySelector('meta[name="csp-nonce"]')) == null
          ? void 0
    ...
    var initializeClientHydrate = (hostElm, tagName, hostId, hostRef) => {
      ...
      for (crIndex; crIndex < crLength; crIndex++) {
        ...
        if (!shadowRoot) {
          ...
          ((_a2 = childRenderNode.$tag$) == null ? void 0 : _a2.toString().includes("-")) &&
          childRenderNode.$tag$ !== "slot-fb" &&
          !childRenderNode.$elm$.shadowRoot
        ) {
          const cmpMeta = getHostRef(childRenderNode.$elm$);
          if (cmpMeta) {
            const scopeId3 = getScopeId(cmpMeta.$cmpMeta$);
    ...
    var parseVNodeAnnotations = (doc, node, docData, orgLocationNodes) => {
      ...
      if (node.nodeType === 1 /* ElementNode */) {
        const childNodes = [
          ...
          ...Array.from(((_a2 = node.shadowRoot) == null ? void 0 : _a2.childNodes) || [])
        ];
          ...
          const src = __privateGet(this, _parts)
            .map(p => {
              ...
              const [re, _, hasMagic, uflag] =
                typeof p === "string"
                  ? __privateMethod((_a3 = _a), _AST_static, parseGlob_fn).call(
                      _a3,
                      p,
                      __privateGet(this, _hasMagic),
                      noEmpty
    ...
    parseAST_fn = function (str, ast, pos, opt, extDepth) {
      ...
      while (i2 < str.length) {
        ...
        const doRecurse =
          isExtglobType(c) &&
          str.charAt(i2) === "(" /* c8 ignore start - the maxDepth is sufficient here */ &&
    ...
    canAdopt_fn = function (child, map2 = adoptionMap) {
      if (
        ...
        typeof child !== "object" ||
        child.type !== null ||
        __privateGet(child, _parts).length !== 1 ||
        this.type === null
      ) {
        return false;
      }
    ...
    adopt_fn = function (child, index) {
      ...
      for (const p of __privateGet(gc, _parts)) {
        if (typeof p === "object") __privateSet(p, _parent, this);
      }
    ...
    flatten_fn = function () {
      ...
      if (!isExtglobAST(this)) {
        for (const p of __privateGet(this, _parts)) {
          if (typeof p === "object") __privateMethod((_a2 = p), _AST_instances, flatten_fn).call(_a2);
        }
      } else {
        let iterations = 0;
        let done = false;
    ...
    var Minimatch = class {
      ...
      matchOne(file, pattern, partial = false) {
        ...
        if (pattern.includes(GLOBSTAR)) {
          return __privateMethod(this, _Minimatch_instances, matchGlobstar_fn).call(
            this,
            file,
            pattern,
            partial,
        ...
        return __privateMethod(this, _Minimatch_instances, matchOne_fn).call(
          this,
          file,
          pattern,
          partial,
    ...
    matchGlobstar_fn = function (file, pattern, partial, fileIndex, patternIndex) {
      ...
      return !!__privateMethod(this, _Minimatch_instances, matchGlobStarBodySections_fn).call(
        this,
        file,
        bodySegments,
        fileIndex,
    ...
    matchGlobStarBodySections_fn = function (
      file,
      bodySegments,
      fileIndex,
      bodyIndex,
      ...
      while (fileIndex <= after) {
        const m = __privateMethod(this, _Minimatch_instances, matchOne_fn).call(
          this,
        ...
        if (m && globStarDepth < this.maxGlobstarRecursion) {
          const sub = __privateMethod(this, _Minimatch_instances, matchGlobStarBodySections_fn).call(
            this,
            file,
            bodySegments,
        ...
        members.forEach(([memberName, [memberFlags, metaAttributeName]]) => {
          ...
          if (memberFlags & 31 /* Prop */) {
            ...
            if (attrPropVal !== void 0) {
              ...
              (_b = hostRef == null ? void 0 : hostRef.$instanceValues$) == null
                ? void 0
            ...
            hostRef.$fetchedCbList$.push(() => {
              var _a3;
              if (
                !((_a3 = hostRef == null ? void 0 : hostRef.$instanceValues$) == null ? void 0 : _a3.has(memberName))
              ) {
                setValue(
                  elm,
                  memberName,
            ...
            Object.defineProperty(elm, memberName, {
              value(...args) {
                var _a3;
                const ref = getHostRef(this);
                return (_a3 = ref == null ? void 0 : ref.$onInstancePromise$) == null
                  ? void 0
                  : _a3
                      .then(() => {
                        var _a4;
                        return (_a4 = ref == null ? void 0 : ref.$lazyInstance$) == null
                          ? void 0
                          : _a4[memberName](...args);
                      })
                      .catch(e => {
...
${indent}${ln}`;
    ...
    class SgdsButton {
      constructor(hostRef) {
        ...
        this.sgdsBlur = createEvent(this, "sgds-blur");
        this.sgdsFocus = createEvent(this, "sgds-focus");
      ...
      getInnerElement() {
        var _a, _b;
        return (_b = (_a = this.el.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector(".btn")) !==
          null && _b !== void 0
          ? _b
          : null;
      }
        ...
        return hAsync(
          ...
          hAsync(
            ...
            this.loading
              ...
              : [
                  hAsync("slot", { name: "leftIcon", onSlotchange: this.handleSlotChange }),
                  hAsync("span", null, hAsync("slot", null)),
                  hAsync("slot", { name: "rightIcon", onSlotchange: this.handleSlotChange })
                ]
          )
        );
      }
      ...
      static get style() {
        return sgdsElementCss$1() + (buttonCss$1() + buttonCss());
      }
      static get cmpMeta() {
        return {
          $flags$: 265,
      ...
      render() {
        return hAsync(
          ...
          hAsync(
            ...
            !this.label &&
              hAsync("span", { key: "a643ce4b9f68886a7378010d067b1a600076ddd9", class: "sr-only" }, "Loading...")
          ),
          this.label &&
            hAsync("span", { key: "5b6a36a940800d5229438f6e254b573f18fba359", class: "spinner-label" }, this.label)
        );
      }
      static get style() {
        return sgdsElementCss() + spinnerCss();
      }
      static get cmpMeta() {
        return {
          $flags$: 9,
    ...
    registerComponents([SgdsButton, SgdsSpinner]);
...
var EntityDecoder = class {
  ...
  emitNumericEntity(lastCp, expectedLength) {
    ...
    if (this.consumed <= expectedLength) {
      (_a3 = this.errors) === null || _a3 === void 0
        ? void 0
        : _a3.absenceOfDigitsInNumericCharacterReference(this.consumed);
      return 0;
    }
...
var Tokenizer = class {
  ...
  _err(code, cpOffset = 0) {
    var _a3, _b;
    (_b = (_a3 = this.handler).onParseError) === null || _b === void 0
      ? void 0
      : _b.call(_a3, this.preprocessor.getError(code, cpOffset));
  }
  ...
  _leaveAttrName() {
    ...
    if (getTokenAttr(token, this.currentAttr.name) === null) {
      ...
      if (token.location && this.currentLocation) {
        const attrLocations =
          (_a3 = (_b = token.location).attrs) !== null && _a3 !== void 0
            ? _a3
...
var Parser = class {
  ...
  onItemPop(node, isTop) {
    ...
    (_b = (_a3 = this.treeAdapter).onItemPop) === null || _b === void 0
      ? void 0
      : _b.call(_a3, node, this.openElements.current);
    if (isTop) {
      let current;
      let currentTagId;
...
function endTagAfterBody(p, token) {
  ...
  if (token.tagID === TAG_ID.HTML) {
    ...
    if (p.options.sourceCodeLocationInfo && p.openElements.tagIDs[0] === TAG_ID.HTML) {
      ...
      if (
        bodyElement &&
        !((_a3 = p.treeAdapter.getNodeSourceCodeLocation(bodyElement)) === null || _a3 === void 0 ? void 0 : _a3.endTag)
      ) {
        p._setEndLocation(bodyElement, token);
      }
    }
      ...
      function tokenize(selector, parseOnly) {
        ...
        while (soFar) {
          ...
          for (type in filterMatchExpr) {
            if (
              (match2 = jQuery.expr.match[type].exec(soFar)) &&
              (!preFilters[type] || (match2 = preFilters[type](match2)))
            ) {
              matched = match2.shift();
              tokens.push({
                value: matched,
...
function updateSelectorError(selector, e) {
  ...
  if (selectorsPresent.length > 0 && e.message) {
    e.message =
      `At present jQuery does not support the ${humanReadableList(selectorsPresent)} ${
        selectorsPresent.length === 1 ? "selector" : "selectors"
      }.
  ...
  if (node.nodeType === 1 /* ELEMENT_NODE */ || isShadowRoot) {
    ...
    if (ignoreTag === false) {
      const isWithinWhitespaceSensitiveNode =
        opts.newLines || ((_a3 = opts.indentSpaces) != null ? _a3 : 0) > 0 ? isWithinWhitespaceSensitive(node) : false;
...
var AST = class {
  ...
  toJSON() {
    ...
    if (
      ...
      (this === __privateGet(this, _root) ||
        (__privateGet(__privateGet(this, _root), _filledNegs) &&
          ((_a3 = __privateGet(this, _parent)) == null ? void 0 : _a3.type) === "!"))
    ) {
      ret.push({});
    }
    return ret;
  ...
  isStart() {
    var _a3;
    if (__privateGet(this, _root) === this) return true;
    if (!((_a3 = __privateGet(this, _parent)) == null ? void 0 : _a3.isStart())) return false;
    if (__privateGet(this, _parentIndex) === 0) return true;
    const p = __privateGet(this, _parent);
  ...
  isEnd() {
    var _a3, _b, _c;
    if (__privateGet(this, _root) === this) return true;
    if (((_a3 = __privateGet(this, _parent)) == null ? void 0 : _a3.type) === "!") return true;
    if (!((_b = __privateGet(this, _parent)) == null ? void 0 : _b.isEnd())) return false;
    if (!this.type) return (_c = __privateGet(this, _parent)) == null ? void 0 : _c.isEnd();
    const pl = __privateGet(this, _parent) ? __privateGet(__privateGet(this, _parent), _parts).length : 0;
    return __privateGet(this, _parentIndex) === pl - 1;
    ...
    if (!isExtglobAST(this)) {
      ...
      const src = __privateGet(this, _parts)
        .map(p => {
          ...
          const [re, _, hasMagic, uflag] =
            typeof p === "string"
              ? __privateMethod((_a4 = _a2), _AST_static, parseGlob_fn).call(
                  _a4,
                  p,
                  __privateGet(this, _hasMagic),
                  noEmpty
...
flatten_fn = function () {
  ...
  if (!isExtglobAST(this)) {
    for (const p of __privateGet(this, _parts)) {
      if (typeof p === "object") __privateMethod((_a3 = p), _AST_instances, flatten_fn).call(_a3);
    }
  } else {
    let iterations = 0;
    let done = false;
...
var serializeCssKeyframe = (opts, node) => {
  var _a3, _b;
  return (
    ((_b = (_a3 = node.values) == null ? void 0 : _a3.join(",")) != null ? _b : "") +
    "{" +
    serializeCssMapVisit(opts, node.declarations) +
    "}"
  );
