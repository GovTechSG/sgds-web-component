...
const BUILD = /* sgds */ { hotModuleReplacement: false, hydratedSelectorName: "hydrated", propChangeCallback: false, slotRelocation: true, state: true, updatable: true};
...
class SgdsButton {
    ...
    getInnerElement() {
        var _a, _b;
        return (_b = (_a = this.el.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('.btn')) !== null && _b !== void 0 ? _b : null;
    }
    checkSlots() {
    ...
    render() {
        ...
        return (hAsync(Host, { key: 'd6ff239c0e700beb9244c671a5c2a24a89af04fa' }, hAsync(Tag, Object.assign({ key: '0d99cbc70cc74b71325968930bc2090b80afb1be' }, attrs), this.loading
            ? (hAsync("sgds-spinner", { size: this.assignSpinnerSize(this.size), tone: this.assignSpinnerTone(this.tone, this.variant) }))
            : ([
    ...
    static get style() { return sgdsElementCss$1() + (buttonCss$1() + buttonCss()); }
...
class SgdsSpinner {
    ...
    render() {
        return (hAsync("div", { key: '630884f9499df1017dd80395fa71c0aa13003fc0', class: {
                'spinner-wrapper': true,
                'horizontal': this.orientation === 'horizontal',
            } }, hAsync("div", { key: 'c0d29587ed8ebbfde3e8ddde8c3a7ba273c13555', class: {
                'spinner': true,
                [`spinner-${this.size}`]: !!this.size,
            }, role: "status" }, !this.label && hAsync("span", { key: 'a643ce4b9f68886a7378010d067b1a600076ddd9', class: "sr-only" }, "Loading...")), this.label && hAsync("span", { key: '5b6a36a940800d5229438f6e254b573f18fba359', class: "spinner-label" }, this.label)));
    }
    static get style() { return sgdsElementCss() + spinnerCss(); }
    static get cmpMeta() { return {
        "$flags$": 9,
        ...
        "$listeners$": undefined,
        "$lazyBundleId$": "-",
        "$attrsToReflect$": [["tone", "tone"], ["variant", "variant"], ["size", "size"], ["label", "label"], ["orientation", "orientation"]]
    }; }
}
