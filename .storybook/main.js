...
module.exports = {
  stories: [
    ...
    // "../stories/components/Card.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/Checkbox.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/CloseButton.@(mdx|stories.@(js|jsx|ts|tsx))",
    ...
    // "../stories/components/Drawer.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/Dropdown.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/FileUpload.@(mdx|stories.@(js|jsx|ts|tsx))",
    ...
    // "../stories/components/IconCard.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/IconList.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/ImageCard.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/Input.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/Link.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/Mainnav.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/Masthead.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/Modal.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/OverflowMenu.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/Pagination.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/ProgressBar.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/QuantityToggle.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/Radio.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/Select.@(mdx|stories.@(js|jsx|ts|tsx))",
    ...
    // "../stories/components/Subnav.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/Switch.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/SystemBanner.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/Tab.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/Table.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/TableOfContents.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/Textarea.@(mdx|stories.@(js|jsx|ts|tsx))",
    // "../stories/components/ThumbnailCard.@(mdx|stories.@(js|jsx|ts|tsx))",
