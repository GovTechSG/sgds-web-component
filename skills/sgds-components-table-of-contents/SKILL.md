---
name: "sgds-components-table-of-contents"
description: "Use sgds-table-of-contents to render an in-page navigation list that links to sections on the page. Apply this skill whenever a user asks about a table of contents, in-page nav, page outline, anchor links navigation, or content jump links in SGDS."
metadata:
