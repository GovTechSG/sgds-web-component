---
name: "sgds-components-overflow-menu"
description: "Use the sgds-overflow-menu web component to display a three-dot icon button that toggles a dropdown menu of actions. Apply this skill whenever a user asks about overflow menus, three-dot menus, kebab menus, action menus on table rows, or contextual action icons in SGDS."
metadata:
