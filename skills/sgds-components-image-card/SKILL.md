---
name: "sgds-components-image-card"
description: "Use the sgds-image-card web component to display a card where a photograph or image is the primary visual, with optional image badge and action overlays. Apply this skill whenever a user asks about image cards, photo cards, cards with image overlays, image badge on card, or cards with image action buttons in SGDS."
metadata:
