---
name: "sgds-pattern-layout"
description: "Use this skill when users ask about app layout, page structure, sidebar layout, dashboard layout, transactional app layout, simple app layout, sgds-container, sgds-container-sidebar, sticky header, or how to structure an SGDS application."
metadata:
...
# SGDS App Layout Pattern

SGDS provides two recommended application layout templates. Choose based on your app type.

## Prerequisites

Import these CSS files before using any layout:

```javascript
import "@govtechsg/sgds-web-component/themes/day.css";
import "@govtechsg/sgds-web-component/css/sgds.css";       // foundation + grid
import "@govtechsg/sgds-web-component/css/utility.css";    // sgds: utility classes
```
