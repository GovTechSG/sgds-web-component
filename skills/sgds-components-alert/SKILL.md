---
name: "sgds-components-alert"
description: "Use the sgds-alert and sgds-alert-link web components to show contextual feedback messages. Apply this skill whenever a user asks about alerts, banners, notification messages, dismissible alerts, alert variants (info, success, danger, warning, neutral), outlined alerts, or inline alert links in SGDS."
metadata:
