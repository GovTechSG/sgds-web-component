---
name: "sgds-components-sidenav"
description: "Use sgds-sidenav, sgds-sidenav-item, and sgds-sidenav-link to build a vertical sidebar navigation with multi-level nesting. Apply this skill whenever a user asks about side navigation, sidebar menus, nested navigation, vertical nav, or collapsible sidebar sections in SGDS."
metadata:
