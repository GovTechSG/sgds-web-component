...
- **sgds-utilities-spacing** - Margin, padding, gap utilities
- **sgds-utilities-background-color** - Background colors and surfaces
- **sgds-utilities-text-color** - Text colors and typography colors
- **sgds-utilities-border-color** - Border colors
- **sgds-utilities-border-width** - Border thickness and sides
- **sgds-utilities-border-radius** - Rounded corners
- **sgds-utilities-typography** - Font sizes, weights, spacing
- **sgds-utilities-opacity** - Transparency and overlays
