---
name: "sgds-components-textarea"
description: "Use sgds-textarea to display a multi-line text input with label, hint text, character count, resize control, and validation feedback. Apply this skill whenever a user asks about textareas, multi-line inputs, text areas, comment fields, or long-form text inputs in SGDS."
metadata:
