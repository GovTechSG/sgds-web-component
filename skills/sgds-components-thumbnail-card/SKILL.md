---
name: "sgds-components-thumbnail-card"
description: "Use the sgds-thumbnail-card web component to display a card with a small thumbnail image beside or above the content. Apply this skill whenever a user asks about thumbnail cards, compact image cards, logo cards, or list-style cards with small images in SGDS."
metadata:
