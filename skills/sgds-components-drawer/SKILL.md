---
name: "sgds-components-drawer"
description: "Use the sgds-drawer web component to display a panel that slides in from the edge of the screen. Apply this skill whenever a user asks about drawers, side panels, off-canvas menus, overlay panels, or slide-in navigation in SGDS."
metadata:
