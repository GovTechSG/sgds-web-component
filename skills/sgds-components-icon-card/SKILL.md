---
name: "sgds-components-icon-card"
description: "Use the sgds-icon-card web component to display a card with a prominent icon, title, description, and footer. Apply this skill whenever a user asks about icon cards, feature cards with icons, service cards, or icon-led card layouts in SGDS."
metadata:
