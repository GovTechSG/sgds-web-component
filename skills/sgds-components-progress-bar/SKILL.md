---
name: "sgds-components-progress-bar"
description: "Use sgds-progress-bar to display a visual progress indicator for a task or value. Apply this skill whenever a user asks about progress bars, loading progress, step completion percentage, value indicators, or completion tracking in SGDS."
metadata:
