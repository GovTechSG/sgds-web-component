---
name: "sgds-components-combo-box"
description: "Use sgds-combo-box and sgds-combo-box-option for a searchable, filterable dropdown with optional multi-select, async data loading, and badge display. Apply this skill whenever a user asks about combo boxes, searchable selects, autocomplete dropdowns, filterable dropdowns, multi-select fields, or typeahead inputs in SGDS."
metadata:
