---
name: sgds-utilities-opacity
description: "Use SGDS opacity utilities with the sgds: prefix for transparency levels and fading effects. Apply this skill whenever a user asks about transparency, opacity levels, fading elements, or semi-transparent overlays in SGDS designs."
metadata:
