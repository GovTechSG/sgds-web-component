---
name: "sgds-components-modal"
description: "Use the sgds-modal web component to display a dialog overlay that interrupts the user for confirmation, alerts, or focused tasks. Apply this skill whenever a user asks about modals, dialogs, confirmation dialogs, alert dialogs, or overlay popups in SGDS."
metadata:
