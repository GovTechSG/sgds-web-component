...
For definitions of suffix modifiers (`default`, `emphasis`, `muted`, `fixed-light`, `fixed-dark`, `inverse`, `surface`), see **[`utilities-color-semantics`](../sgds-utilities-color-semantics/SKILL.md)**.
