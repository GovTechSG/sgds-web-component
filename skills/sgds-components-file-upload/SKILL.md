---
name: "sgds-components-file-upload"
description: "Use sgds-file-upload to display a file upload button with selected file list, validation, and support for multiple files. Apply this skill whenever a user asks about file uploads, file input, document upload, multi-file selection, or attachment fields in SGDS."
metadata:
