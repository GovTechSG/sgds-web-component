---
name: "sgds-components-stepper"
description: "Use sgds-stepper to display a multi-step workflow with step navigation. Apply this skill whenever a user asks about steppers, multi-step forms, wizard navigation, step-by-step flows, onboarding steps, or progress through sequential tasks in SGDS."
metadata:
