...
> **Common mistake**: The word "color" never appears in the class name. Do NOT write `sgds:text-color-subtle`, `sgds:text-color-default`, etc. The correct classes are `sgds:text-subtle`, `sgds:text-default`, etc.
