---
name: sgds-utilities-spacing
description: "Use SGDS spacing utilities with the sgds: prefix for margin, padding, and gap. Semantic spacing utilities (sgds:gap-text-*, sgds:gap-layout-*, sgds:p-layout-*, sgds:gap-component-*, sgds:p-component-*, sgds:w-container) are always preferred over raw numeric utilities (sgds:p-4, sgds:gap-6, etc.) — they are responsive and encode design intent. Apply this skill whenever a user asks about spacing, margins, padding, gaps, layout spacing, or component spacing in SGDS designs."
metadata:
