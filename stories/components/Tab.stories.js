    ...
    import { Template, args, parameters, play } from "../templates/Tab/basic.js";

    export default {
      title: 'Components/Tab',
      component: 'sgds-tab',
      argTypes: {"variant":{"defaultValue":"underlined","control":"select","options":["underlined","solid"]},"orientation":{"defaultValue":"horizontal","control":"select","options":["horizontal","vertical"]},"density":{"defaultValue":"default","control":"select","options":["compact","default"]},"name":{"defaultValue":"","control":"text"},"active":{"defaultValue":false,"control":"boolean"},"panel":{"defaultValue":"","control":"text"},"disabled":{"defaultValue":false,"control":"boolean"}}
    }
