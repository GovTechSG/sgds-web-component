    ...
    import { Template, args, parameters, play } from "../templates/Select/basic.js";

    export default {
      title: 'Components/Select',
      component: 'sgds-select',
      argTypes: {"_renderItemContent":{"control":"object"},"disabled":{"defaultValue":false,"control":"boolean"},"value":{"defaultValue":"","control":"text"},"childName":{"defaultValue":"sgds-select-option","control":"text"},"options":{"control":"object"},"label":{"defaultValue":"","control":"text"},"hintText":{"defaultValue":"","control":"text"},"name":{"control":"text"},"placeholder":{"control":"text"},"autofocus":{"defaultValue":false,"control":"boolean"},"required":{"defaultValue":false,"control":"boolean"},"loading":{"defaultValue":false,"control":"boolean"},"displayValue":{"defaultValue":"","control":"text"},"hasFeedback":{"defaultValue":false,"control":"boolean"},"invalidFeedback":{"defaultValue":"","control":"text"},"invalid":{"defaultValue":false,"control":"boolean"},"menuList":{"defaultValue":"[]","control":"object"},"selectedItems":{"defaultValue":"[]","control":"object"},"_isTouched":{"defaultValue":false,"control":"boolean"},"_input":{"control":"object"},"validity":{"control":"object"},"validationMessage":{"control":"text"},"_controlId":{"control":"object"},"_labelId":{"control":"object"},"floatingOpts":{"defaultValue":"{\n      middleware: [\n        size({\n          apply({ rects, elements }) {\n            elements.floating.style.width = `${rects.reference.width}px`;\n          }\n        })\n      ]\n    }","control":"object"},"hidden":{"defaultValue":false,"control":"boolean"},"menuIsOpen":{"defaultValue":false,"control":"boolean"},"close":{"defaultValue":"default","control":"select","options":["outside","default","inside"]},"readonly":{"defaultValue":false,"control":"boolean"}}
    }
