    ...
    import { Template, args, parameters, play } from "../templates/Table/basic.js";

    export default {
      title: 'Components/Table',
      component: 'sgds-table',
      argTypes: {"responsive":{"control":"select","options":["sm","md","lg","xl","always"]},"rowHeader":{"defaultValue":"[]","control":"object"},"columnHeader":{"defaultValue":"[]","control":"object"},"tableData":{"defaultValue":"[]","control":"select","options":["Array<(string","number)[]>"]},"headerPosition":{"defaultValue":"horizontal","control":"select","options":["horizontal","vertical","both"]},"headerBackground":{"defaultValue":false,"control":"boolean"},"tableBorder":{"defaultValue":false,"control":"boolean"}}
    }
