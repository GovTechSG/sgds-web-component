    ...
    import { Template, args, parameters, play } from "../templates/Datepicker/basic.js";

    export default {
      title: 'Components/Datepicker',
      component: 'sgds-datepicker',
      argTypes: {"required":{"defaultValue":false,"control":"boolean"},"name":{"control":"text"},"disabled":{"defaultValue":false,"control":"boolean"},"value":{"defaultValue":"","control":"text"},"initialValue":{"defaultValue":"[]","control":"object"},"minDate":{"defaultValue":"","control":"text"},"maxDate":{"defaultValue":"","control":"text"},"mode":{"defaultValue":"single","control":"select","options":["single","range"]},"invalidFeedback":{"control":"text"},"hasFeedback":{"defaultValue":false,"control":"boolean"},"label":{"defaultValue":"","control":"text"},"hintText":{"defaultValue":"","control":"text"},"noFlip":{"defaultValue":false,"control":"boolean"},"drop":{"defaultValue":"down","control":"select","options":["up","down"]},"displayDate":{"control":"object"},"defaultValue":{"defaultValue":"","control":"text"},"validity":{"control":"object"},"validationMessage":{"control":"object"},"floatingOpts":{"defaultValue":"{\n      placement: bottom-end\n    }","control":"object"},"menuIsOpen":{"defaultValue":false,"control":"boolean"},"close":{"defaultValue":"default","control":"select","options":["outside","default","inside"]},"readonly":{"defaultValue":false,"control":"boolean"}}
    }
