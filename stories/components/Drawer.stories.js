    ...
    import { Template, args, parameters, play } from "../templates/Drawer/basic.js";

    export default {
      title: 'Components/Drawer',
      component: 'sgds-drawer',
      argTypes: {"open":{"defaultValue":false,"control":"boolean"},"size":{"defaultValue":"sm","control":"select","options":["sm","md","lg"]},"placement":{"defaultValue":"end","control":"select","options":["top","end","bottom","start"]},"contained":{"defaultValue":false,"control":"boolean"}}
    }
