    ...
    import { Template, args, parameters, play } from "../templates/Button/basic.js";

    export default {
      title: 'Components/Button',
      component: 'sgds-button',
      argTypes: {"type":{"defaultValue":"button","control":"select","options":["button","submit","reset"]},"form":{"control":"text"},"formAction":{"control":"text"},"formMethod":{"control":"select","options":["post","get"]},"formNoValidate":{"defaultValue":false,"control":"boolean"},"formTarget":{"control":"select","options":["","_self","_blank","_parent","_top","string"]},"fullWidth":{"defaultValue":false,"control":"boolean"},"hasLeftIconSlot":{"defaultValue":false,"control":"boolean"},"hasRightIconSlot":{"defaultValue":false,"control":"boolean"},"variant":{"defaultValue":"primary","control":"select","options":["primary","outline","ghost","danger"]},"tone":{"defaultValue":"brand","control":"select","options":["brand","danger","fixed-light","neutral"]},"size":{"defaultValue":"md","control":"select","options":["xs","sm","md","lg"]},"active":{"defaultValue":false,"control":"boolean"},"disabled":{"defaultValue":false,"control":"boolean"},"href":{"control":"text"},"target":{"defaultValue":"_self","control":"select","options":["_blank","_parent","_self","_top"]},"download":{"control":"text"},"ariaLabel":{"control":"text"},"loading":{"defaultValue":false,"control":"boolean"}}
    }
