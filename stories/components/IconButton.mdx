...
<Canvas>
  <Story of={IconButtonStories.Basic} />
</Canvas>
...
```html
<script src="https://cdn.jsdelivr.net/npm/@govtechsg/sgds-web-component@3.16.0/components/IconButton/index.umd.min.js"></script>
```
