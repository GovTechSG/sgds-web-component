...
import * as ThumbnailCardStories from "./ThumbnailCard.stories";

<Meta of={ThumbnailCardStories} />
...
<Canvas>
  <Story of={ThumbnailCardStories.Basic} />
</Canvas>
...
```js
import "@govtechsg/sgds-web-component/components/ThumbnailCard";
```

### CDN

```html
<script src="https://cdn.jsdelivr.net/npm/@govtechsg/sgds-web-component@3.16.0/components/ThumbnailCard/index.umd.min.js"></script>
```
...
<ArgTypes of="sgds-thumbnail-card" />
...
<Canvas of={ThumbnailCardStories.Stretched}>
  <Story of={ThumbnailCardStories.Stretched} />
</Canvas>
...
<Canvas of={ThumbnailCardStories.Disabled}>
  <Story of={ThumbnailCardStories.Disabled} />
</Canvas>
...
<Canvas of={ThumbnailCardStories.Orientation}>
  <Story of={ThumbnailCardStories.Orientation} />
</Canvas>
...
<Canvas of={ThumbnailCardStories.HideBorder}>
  <Story of={ThumbnailCardStories.HideBorder} />
</Canvas>
...
<Canvas of={ThumbnailCardStories.Tinted}>
  <Story of={ThumbnailCardStories.Tinted} />
</Canvas>
...
<Canvas of={ThumbnailCardStories.NoPadding}>
  <Story of={ThumbnailCardStories.NoPadding} />
</Canvas>