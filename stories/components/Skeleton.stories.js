    ...
    import { Template, args, parameters, play } from "../templates/Skeleton/basic.js";

    export default {
      title: 'Components/Skeleton',
      component: 'sgds-skeleton',
      argTypes: {"width":{"defaultValue":"","control":"text"},"height":{"defaultValue":"","control":"text"},"borderRadius":{"defaultValue":"","control":"text"},"rows":{"control":"number"},"sheen":{"defaultValue":false,"control":"boolean"}}
    }
