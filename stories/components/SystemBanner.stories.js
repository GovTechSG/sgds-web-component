    ...
    import { Template, args, parameters, play } from "../templates/SystemBanner/basic.js";

    export default {
      title: 'Components/SystemBanner',
      component: 'sgds-system-banner',
      argTypes: {"hasActionSlot":{"defaultValue":false,"control":"boolean"},"noClampAction":{"defaultValue":false,"control":"boolean"},"show":{"defaultValue":false,"control":"boolean"},"dismissible":{"defaultValue":false,"control":"boolean"},"fluid":{"defaultValue":false,"control":"boolean"}}
    }
