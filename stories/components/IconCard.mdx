...
<Canvas>
  <Story of={IconCardStories.Basic} />
</Canvas>
...
### React
    ...
    ``` jsx
    import SgdsIconCard  from "@govtechsg/sgds-web-component/react/icon-card/index.js";
    ```

### Others (Vue, Angular, plain HTML etc.)

```js
import "@govtechsg/sgds-web-component/components/IconCard";
```

### CDN

```html
<script src="https://cdn.jsdelivr.net/npm/@govtechsg/sgds-web-component@3.16.0/components/IconCard/index.umd.min.js"></script>
```
