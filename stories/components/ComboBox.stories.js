    ...
    import { Template, args, parameters, play } from "../templates/ComboBox/basic.js";

    export default {
      title: 'Components/ComboBox',
      component: 'sgds-combo-box',
      argTypes: {"_renderItemContent":{"control":"object"},"disabled":{"defaultValue":false,"control":"boolean"},"value":{"defaultValue":"","control":"text"},"childName":{"defaultValue":"sgds-combo-box-option","control":"text"},"multiSelect":{"defaultValue":false,"control":"boolean"},"badgeFullWidth":{"defaultValue":false,"control":"boolean"},"clearable":{"defaultValue":false,"control":"boolean"},"async":{"defaultValue":false,"control":"boolean"},"emptyMenuAsync":{"defaultValue":false,"control":"boolean"},"filterFunction":{"control":"object"},"options":{"control":"object"},"isFocused":{"defaultValue":false,"control":"boolean"},"suffixIconTemplate":{"defaultValue":"html`<sgds-icon\n    name=${this.menuIsOpen ? chevron-up : chevron-down}\n    size=md\n  ></sgds-icon>`","control":"object"},"prefixIconTemplate":{"defaultValue":"html`${nothing}`","control":"object"},"label":{"defaultValue":"","control":"text"},"hintText":{"defaultValue":"","control":"text"},"name":{"control":"text"},"placeholder":{"control":"text"},"autofocus":{"defaultValue":false,"control":"boolean"},"required":{"defaultValue":false,"control":"boolean"},"loading":{"defaultValue":false,"control":"boolean"},"displayValue":{"defaultValue":"","control":"text"},"hasFeedback":{"defaultValue":false,"control":"boolean"},"invalidFeedback":{"defaultValue":"","control":"text"},"invalid":{"defaultValue":false,"control":"boolean"},"menuList":{"defaultValue":"[]","control":"object"},"selectedItems":{"defaultValue":"[]","control":"object"},"_isTouched":{"defaultValue":false,"control":"boolean"},"_input":{"control":"object"},"validity":{"control":"object"},"validationMessage":{"control":"text"},"_controlId":{"control":"object"},"_labelId":{"control":"object"},"floatingOpts":{"defaultValue":"{\n      middleware: [\n        size({\n          apply({ rects, elements }) {\n            elements.floating.style.width = `${rects.reference.width}px`;\n          }\n        })\n      ]\n    }","control":"object"},"hidden":{"defaultValue":false,"control":"boolean"},"menuIsOpen":{"defaultValue":false,"control":"boolean"},"close":{"defaultValue":"default","control":"select","options":["outside","default","inside"]},"readonly":{"defaultValue":false,"control":"boolean"}}
    }
