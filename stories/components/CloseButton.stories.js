    ...
    import { Template, args, parameters, play } from "../templates/CloseButton/basic.js";

    export default {
      title: 'Components/CloseButton',
      component: 'sgds-close-button',
      argTypes: {"size":{"defaultValue":"md","control":"select","options":["sm","md"]},"tone":{"defaultValue":"default","control":"select","options":["default","fixed-dark","fixed-light"]}}
    }
