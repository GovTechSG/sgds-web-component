    ...
    import { Template, args, parameters, play } from "../templates/Icon/basic.js";

    export default {
      title: 'Components/Icon',
      component: 'sgds-icon',
      argTypes: {"name":{"control":"text"},"size":{"defaultValue":"lg","control":"select","options":["xs","sm","md","lg","xl","2-xl","3-xl"]}}
    }
