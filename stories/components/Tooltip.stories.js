    ...
    import { Template, args, parameters, play } from "../templates/Tooltip/basic.js";

    export default {
      title: 'Components/Tooltip',
      component: 'sgds-tooltip',
      argTypes: {"content":{"defaultValue":"","control":"text"},"placement":{"defaultValue":"top","control":"select","options":["top","bottom","left","right"]},"trigger":{"defaultValue":"hover focus","control":"select","options":["click","hover","focus","hover focus"]}}
    }
