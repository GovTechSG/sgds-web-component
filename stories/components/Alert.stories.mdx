...
<Meta
  ...
  argTypes={{
    ...
    "sgds-show": {
      description:
        "Emitted event with toggleShow method when sgds-button is clicked",
      table: {
        category: `Event: SgdsAlert`,
      },
    },
    toggleShow: {
      control: "disable",
      description: "When invoked, shows the alert message",
      table: {
        category: "methods: SgdsAlert",
        type: {
          summary: "function",
        },
      },
...
export const TemplateWithButton = (args) =>
  html`
    ...
    <sgds-button variant="danger" @click=${toggleShow}>
      Show Alert
    </sgds-button>
  `;

export const toggleShow = () => {
  const alert = document.querySelector("#alertExample");
  alert.toggleShow();
};
...
<Canvas>
  <Story name='Basic with Icon'>
    ${variants.map((variant) => {
      return html` <sgds-alert variant="${variant}" alertClasses="d-flex align-items-center">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
        height="16"
      ...
      >
        ...
        <path
          d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"
        />
      </svg>This is a ${variant} alert—check
          it out!
    </sgds-alert>`;
    })}
  </Story>
...
Add the dismissible prop to add a dismiss button to the Alert. Here is an example of an `sgds-button` to trigger the alert message using `toggleShow` method.
