    ...
    import { Template, args, parameters, play } from "../templates/Sidebar/basic.js";

    export default {
      title: 'Components/Sidebar',
      component: 'sgds-sidebar',
      argTypes: {"showMenu":{"defaultValue":false,"control":"boolean"},"title":{"defaultValue":"","control":"text"},"name":{"defaultValue":"","control":"text"},"collapsed":{"defaultValue":false,"control":"boolean"},"collapsible":{"defaultValue":false,"control":"boolean"},"separator":{"defaultValue":false,"control":"boolean"},"dependencies":{"defaultValue":"{\n    sgds-icon-button: SgdsIconButton\n  }","control":"object"},"active":{"defaultValue":"","control":"text"},"scrim":{"defaultValue":false,"control":"boolean"},"variant":{"defaultValue":"collapsible","control":"select","options":["collapsible","persistent","overlay"]},"ariaLabel":{"defaultValue":"Sidebar navigation","control":"text"}}
    }
