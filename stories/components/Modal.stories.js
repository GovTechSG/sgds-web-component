    ...
    import { Template, args, parameters, play } from "../templates/Modal/basic.js";

    export default {
      title: 'Components/Modal',
      component: 'sgds-modal',
      argTypes: {"open":{"defaultValue":false,"control":"boolean"},"noAnimation":{"defaultValue":false,"control":"boolean"},"size":{"defaultValue":"md","control":"select","options":["sm","md","lg","xl","fullscreen"]},"hasFooterSlot":{"defaultValue":false,"control":"boolean"},"noCloseButton":{"defaultValue":false,"control":"boolean"}}
    }
