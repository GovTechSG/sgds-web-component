...
```js
import "@govtechsg/sgds-web-component/components/Card";
```

### CDN

```html
<script src="https://cdn.jsdelivr.net/npm/@govtechsg/sgds-web-component@3.16.0/components/Card/index.umd.min.js"></script>
```
