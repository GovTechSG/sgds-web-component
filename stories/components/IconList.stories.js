    ...
    import { Template, args, parameters, play } from "../templates/IconList/basic.js";

    export default {
      title: 'Components/IconList',
      component: 'sgds-icon-list',
      argTypes: {"role":{"defaultValue":"list","control":"text"},"size":{"defaultValue":"md","control":"select","options":["sm","md","lg"]}}
    }
