    ...
    import { Template, args, parameters, play } from "../templates/IconButton/basic.js";

    export default {
      title: 'Components/IconButton',
      component: 'sgds-icon-button',
      argTypes: {"name":{"control":"text"},"variant":{"defaultValue":"primary","control":"select","options":["primary","outline","ghost","danger"]},"tone":{"defaultValue":"brand","control":"select","options":["brand","danger","fixed-light","neutral"]},"size":{"defaultValue":"md","control":"select","options":["xs","sm","md","lg"]},"active":{"defaultValue":false,"control":"boolean"},"disabled":{"defaultValue":false,"control":"boolean"},"href":{"control":"text"},"target":{"defaultValue":"_self","control":"select","options":["_blank","_parent","_self","_top"]},"download":{"control":"text"},"ariaLabel":{"control":"text"},"loading":{"defaultValue":false,"control":"boolean"}}
    }
