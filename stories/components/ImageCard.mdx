...
<Canvas>
  <Story of={ImageCardStories.Basic} />
</Canvas>
...
### React
    ...
    ``` jsx
    import SgdsImageCard  from "@govtechsg/sgds-web-component/react/image-card/index.js";
    ```

### Others (Vue, Angular, plain HTML etc.)

```js
import "@govtechsg/sgds-web-component/components/ImageCard";
```

### CDN

```html
<script src="https://cdn.jsdelivr.net/npm/@govtechsg/sgds-web-component@3.16.0/components/ImageCard/index.umd.min.js"></script>
```
