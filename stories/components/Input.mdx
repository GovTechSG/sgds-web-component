...
```html
<script src="https://cdn.jsdelivr.net/npm/@govtechsg/sgds-web-component@3.16.0/components/Input/index.umd.min.js"></script>
```
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        setValidity(flags: ValidityStateFlags, message: string, anchor:
        HTMLElement)
      </td>
      <td>Checks for validity without any native error popup message</td>
    </tr>
