    ...
    import { Template, args, parameters, play } from "../templates/Checkbox/basic.js";

    export default {
      title: 'Components/Checkbox',
      component: 'sgds-checkbox',
      argTypes: {"label":{"defaultValue":"","control":"text"},"invalidFeedback":{"defaultValue":"","control":"text"},"hasFeedback":{"control":"select","options":["style","text","both"]},"hintText":{"defaultValue":"","control":"text"},"required":{"defaultValue":false,"control":"boolean"},"value":{"control":"text"},"defaultValue":{"defaultValue":"","control":"text"},"validity":{"control":"object"},"validationMessage":{"control":"object"},"name":{"control":"text"},"disabled":{"defaultValue":false,"control":"boolean"},"invalid":{"defaultValue":false,"control":"boolean"},"_controlId":{"control":"object"},"_labelId":{"control":"object"},"checked":{"defaultValue":false,"control":"boolean"},"defaultChecked":{"defaultValue":false,"control":"boolean"},"indeterminate":{"defaultValue":false,"control":"boolean"}}
    }
