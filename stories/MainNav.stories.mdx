...
<Meta
  ...
  argTypes={{
    ...
    active: {
      ...
      control: "text",
      description:
        "Href attribute for anchor element in MainNavItem",
      table: {
        defaultValue: { summary: "" },
        category: "props: MainNavItem",
        type: {
  ...
  return html`
    ...
    >
      <img
        ...
        slot="brand"
      />
      <mainnav-item .active=${active} .href=${href}>Home (argsTable controlled) </mainnav-item>
...
<Canvas>
  <Story name="Basic" args={{ expand: "always" }}>
    {Template.bind({})}
  </Story>
</Canvas>
