...
export const PrimaryColors = () =>
  ColorGrid(
    ...
    ColorItem(
      ...
      "--sgds-primary-surface-translucent",
      "sgds:bg-primary-surface-translucent"
    )
  );
...
export const AccentColors = () =>
  ColorGrid(
    ...
    ColorItem(
      ...
      "--sgds-accent-surface-default",
      "sgds:bg-accent-surface-default",
      "sgds:text-fixed-light"
    ),
    ColorItem(
      "sgds:bg-accent-surface-emphasis",
      "--sgds-accent-surface-emphasis",
      "sgds:bg-accent-surface-emphasis",
      "sgds:text-fixed-light"
    ),
...
export const SuccessColors = () =>
  ColorGrid(
    ...
    ColorItem(
      ...
      "--sgds-success-surface-default",
      "sgds:bg-success-surface-default",
      "sgds:text-fixed-light"
    ),
    ColorItem(
      "sgds:bg-success-surface-emphasis",
      "--sgds-success-surface-emphasis",
      "sgds:bg-success-surface-emphasis",
      "sgds:text-fixed-light"
    ),
...
export const WarningColors = () =>
  ColorGrid(
    ...
    ColorItem(
      ...
      "--sgds-warning-surface-default",
      "sgds:bg-warning-surface-default",
      "sgds:text-fixed-dark"
    ),
    ColorItem(
      "sgds:bg-warning-surface-emphasis",
      "--sgds-warning-surface-emphasis",
      "sgds:bg-warning-surface-emphasis",
      "sgds:text-fixed-dark"
    ),
    ColorItem(
      "sgds:bg-warning-surface-muted",
      "--sgds-warning-surface-muted",
      "sgds:bg-warning-surface-muted",
      "sgds:text-fixed-dark"
    )
  );
...
export const FormColors = () =>
  ColorGrid(
    ...
    ColorItem(
      "sgds:bg-form-surface-fixed-light",
    ...
    ColorItem(
      ...
      "--sgds-form-primary-surface-emphasis",
      "sgds:bg-form-primary-surface-emphasis",
      "sgds:text-fixed-light"
    ),
    ColorItem(
    ...
    ColorItem(
      ...
      "--sgds-form-danger-surface-default",
      "sgds:bg-form-danger-surface-default",
      "sgds:text-fixed-light"
    )
  );
