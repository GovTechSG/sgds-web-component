...
export const PrimaryBorderColors = () =>
  ColorGrid(
    ColorItem(
      ...
      "--sgds-primary-border-color-default"
    ),
    ColorItem(
      "sgds:border-primary-emphasis",
      "--sgds-primary-border-color-emphasis"
    ),
    ColorItem(
      "sgds:border-primary-muted",
      "--sgds-primary-border-color-muted"
    )
  );
...
export const AccentBorderColors = () =>
  ColorGrid(
    ColorItem(
      ...
      "--sgds-accent-border-color-default"
    ),
    ColorItem(
      "sgds:border-accent-emphasis",
      "--sgds-accent-border-color-emphasis"
    ),
    ColorItem(
      "sgds:border-accent-muted",
      "--sgds-accent-border-color-muted"
    )
  );
...
export const SuccessBorderColors = () =>
  ColorGrid(
    ColorItem(
      ...
      "--sgds-success-border-color-default"
    ),
    ColorItem(
      "sgds:border-success-emphasis",
      "--sgds-success-border-color-emphasis"
    ),
    ColorItem(
      "sgds:border-success-muted",
      "--sgds-success-border-color-muted"
    )
  );
...
export const DangerBorderColors = () =>
  ColorGrid(
    ColorItem(
      ...
      "--sgds-danger-border-color-default"
    ),
    ColorItem(
      "sgds:border-danger-emphasis",
      "--sgds-danger-border-color-emphasis"
    ),
    ColorItem(
      "sgds:border-danger-subtle",
      "--sgds-danger-border-color-subtle"
    )
  );
...
export const WarningBorderColors = () =>
  ColorGrid(
    ColorItem(
      ...
      "--sgds-warning-border-color-default"
    ),
    ColorItem(
      "sgds:border-warning-emphasis",
      "--sgds-warning-border-color-emphasis"
    )
  );
