...
const Template = () => {
  return html`
    <section
      class="sgds:bg-default sgds:flex sgds:items-center sgds:min-h-[calc(100vh-108px)]"
    >
      <div
        class="sgds:flex sgds:flex-col sgds:items-start sgds:text-left sgds:p-layout-lg sgds:w-1/2 sgds:box-border"
      >
