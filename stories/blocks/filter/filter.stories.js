    ...
    <div class="sgds:w-container sgds:mx-auto sgds:py-layout-md">
      ...
      <aside class="sgds:w-64 sgds:flex sgds:flex-col sgds:gap-2-xl">
          ...
          <div class="sgds:flex sgds:gap-4 sgds:items-center">
            <span class="sgds:text-heading-sm sgds:font-semibold sgds:leading-sm sgds:tracking-tight sgds:text-heading-default">Filter by</span>
            <sgds-link><a href="#">Clear all</a></sgds-link>
          </div>

          <!-- Programme type -->
          <div class="sgds:flex sgds:flex-col sgds:gap-xs">
            <div class="sgds:text-subtitle-md sgds:font-semibold sgds:leading-xs sgds:tracking-normal sgds:text-heading-default">Programme type</div>
            <sgds-checkbox-group>
          ...
          <!-- Sessions -->
          <div class="sgds:flex sgds:flex-col sgds:gap-xs">
            <div class="sgds:text-subtitle-md sgds:font-semibold sgds:leading-xs sgds:tracking-normal sgds:text-heading-default">Sessions</div>
            <sgds-checkbox-group>
          ...
          <!-- Track -->
          <div class="sgds:flex sgds:flex-col sgds:gap-xs">
            <div class="sgds:text-subtitle-md sgds:font-semibold sgds:leading-xs sgds:tracking-normal sgds:text-heading-default">Track</div>
            <sgds-checkbox-group>
          ...
          <!-- Event hall -->
          <div class="sgds:flex sgds:flex-col sgds:gap-xs">
            <div class="sgds:text-subtitle-md sgds:font-semibold sgds:leading-xs sgds:tracking-normal sgds:text-heading-default">Event hall</div>
            <sgds-checkbox-group>
