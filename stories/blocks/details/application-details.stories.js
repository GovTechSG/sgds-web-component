      ...
      <div class="sgds:bg-surface-default sgds:border sgds:border-muted sgds:rounded-lg sgds:p-component-xs sgds:flex sgds:flex-col sgds:gap-5">
        ...
        <div class="sgds:flex sgds:flex-col sgds:gap-text-md">
          ...
          <div class="sgds:flex sgds:flex-col sgds:gap-text-2-xs">
            ...
            <div class="sgds:text-label-md sgds:font-regular sgds:leading-xs sgds:tracking-normal sgds:text-label-default">This application provides secure access to government services and APIs, enabling seamless integration with external systems. It supports multiple authentication methods and offers comprehensive monitoring and logging capabilities for all API requests.</div>
          </div>
