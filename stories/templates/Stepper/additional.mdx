...
export const StepperFormTemplate = ({ steps }) => {
  return html`
    ...
    <div style="display:flex;justify-content:space-between;margin-top:2rem;">
      <div>
        <sgds-button class="me-3"  variant="primary" @click="${nextStep}"
          >Next</sgds-button
        >
        <sgds-button @click="${previousStep}" variant="secondary"
          >Back</sgds-button
        >
      </div>
      <div>
        <sgds-button class="m-2" variant="danger" @click="${firstStep}"
          >Go to first page</sgds-button
        >
        <sgds-button class="m-2" variant="warning" @click="${lastStep}"
