...
<Canvas>
  <Story name="Variants">
    {() => VariantTemplate(["primary", "secondary", "success", "danger", "warning", "info", "light", "dark"])}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Sizes">
    {() => html`
      <sgds-button size="sm"> sm-button </sgds-button>
      <sgds-button size="lg"> lg-button </sgds-button>
    `}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Active state">
    {() => html`
      <sgds-button variant="primary" active> primary-button </sgds-button>
