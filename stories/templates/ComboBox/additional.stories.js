...
const DefaultFilter = () => {
  return html`<div style="height:300px;display:flex;flex-direction:column;gap:3rem;">
    <sgds-combo-box
      placeholder="Single select combo box with default filter"
      menuList='[
...
const CustomFilter = () => {
  return html`
    <div style="height:300px;display:flex;flex-direction:column;gap:3rem;">
      <sgds-combo-box
        .filterFunction=${(inputValue, menuItem) => menuItem.label.toLowerCase().includes(inputValue)}
