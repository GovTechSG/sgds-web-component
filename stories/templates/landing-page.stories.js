    ...
    <div class="sgds-container">
      <div style="max-width: var(--sgds-text-max-width);">
        ...
        <ul style="padding-left: var(--sgds-spacing-lg); margin: 0;">
          <li class="sgds:text-body-md sgds:font-regular sgds:leading-xs sgds:tracking-normal sgds:text-body-default">Accessibility and inclusivity for all residents, regardless of digital literacy.</li>
          <li class="sgds:text-body-md sgds:font-regular sgds:leading-xs sgds:tracking-normal sgds:text-body-default">Open standards and reusable components that any agency can adopt.</li>
          <li class="sgds:text-body-md sgds:font-regular sgds:leading-xs sgds:tracking-normal sgds:text-body-default">Continuous improvement driven by user research and real feedback.</li>
          <li class="sgds:text-body-md sgds:font-regular sgds:leading-xs sgds:tracking-normal sgds:text-body-default">Security and privacy as foundational requirements, not afterthoughts.</li>
        </ul>
