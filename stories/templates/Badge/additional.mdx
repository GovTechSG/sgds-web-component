...
- Use `info` badge to additional information or context that might be helpful to the user but doesn’t require immediate attention. Commonly used for non-urgent updates, background details, or status labels.
...
A badge with a long text will be truncated to fit the parent's width and a tooltip will be enabled for users to view the full text.
