...
export const SgdsAccordionPlayground = {
  render: () => html`
    ...
    <div style="margin-top: 40px; padding: 20px; border-top: 1px solid #ddd;">
      ...
      <p>
        You can edit the SgdsAccordion's styles by modifying its custom CSS
      ...
      <p>
        You can customize how the SgdsAccordion responds to events. For example:
      </p>
      <pre><code>
      ...
      <p>
        You can modify the SgdsAccordion's attributes directly within the HTML.
        For example:
      </p>
      <pre><code>
