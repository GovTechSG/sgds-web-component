...
export const AccordionPlayground = {
  render: () => html`
    ...
    <div style="margin-top: 40px; padding: 20px; border-top: 1px solid #ddd;">
      ...
      <p>
        You can edit the accordion's and accordion item's css by modifying its custom CSS properties. These can be seen
        in the documentation below. For example, you can change the background colour by editing the following code
        inside
   ...
   --accordion-active-color: darkred;
      ...
      <p>
        You can customize how the accordion responds to events by editing <strong>events.js</strong>. For instance, you
        can change the action triggered by the <code>sgds-show</code> event:
      </p>
      <pre><code>
          accordionItem.addEventListener('sgds-show', () => {
      ...
      <p>
        You can modify the accordion's and accordion item's attributes directly within the HTML to change its appearance
        or behavior. Refer to the documentation below. For instance, try allowing multiple items
        <strong>index.html</strong>:
      </p>
      <pre><code>
           allowMultiple
