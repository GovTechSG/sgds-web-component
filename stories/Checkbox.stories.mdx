...
<Meta
  ...
  argTypes={{
    ...
    required: {
      control: "boolean",
      defaultValue: false,
      description: "Makes the checkbox a required field. On first update renders the invalid state",
      table: {
        category: "props",
        defaultValue: { summary: false },
        type: {
    ...
    Event: {
      ...
      control: "disable",
      description:
        "Emitted when checkbox is clicked. Refer to canvas mode to view event handler in action.",
      table: {
        category: "events",
      },
    },
